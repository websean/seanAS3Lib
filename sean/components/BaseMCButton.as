package sean.components 
{
	...
	public class BaseMCButton extends Sprite
	{
		...
		public function BaseMCButton(Label:String=null, stuffClassName:String=null, button_MC:MovieClip=null) 
		{
			//直接传对象方式
			if (button_MC)
			{
		...
		private function modifyLayout():void
		{
			if (_label)
			{
				...
				_labelText.height = _labelText.textHeight + 5;
				_labelText.width = _labelText.textWidth + 5;
